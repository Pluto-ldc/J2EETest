...
<html>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-8" style="text-align: center;">
					<form class="form-inline" action="addProduct.do" method="post" onsubmit="return check()" enctype="multipart/form-data">
						<table class="table  table-bordered" style="width:100%;">
							<tr class="bg-primary">
								<td style="text-align: center;" colspan="2"><span style="font-size: 20px;">商品添加</span></td>
							</tr>
							<tr class="active">
								<td style="width: 120px; vertical-align: middle">商品名</td>
								<td><input type="text" style="width: 100%;" placeholder="请输入商品名" id="name" class="form-control" name="name" id=""></td>
							</tr>
							<tr class="active">
								<td style="width: 120px; vertical-align: middle">价格</td>
								<td><input type="number" style="width: 100%;" placeholder="请输入价格" id="price" class="form-control" name="price" id=""></td>
							</tr>
							<tr class="active">
								<td style="width: 120px; vertical-align: middle">库存</td>
								<td><input type="number" style="width: 100%;" placeholder="请输入库存" id="sum" class="form-control" name="sum" id=""></td>
							</tr>
							<tr class="active">
								<td style="width: 120px; vertical-align: middle">描述</td>
								<td><textarea name="description" class="form-control" style="width:100%;height:100px" id=""></textarea></td>
							</tr>
							<tr class="active">
	...
	<script type="text/javascript">
			function check() {
				...
				if(document.getElementById("productPic").value==""){
					alert("请选择商品图片！");
					return false;
				}
				return true;
