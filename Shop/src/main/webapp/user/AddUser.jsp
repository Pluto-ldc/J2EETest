		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-8" style="text-align: center;">
					<form class="form-inline" action="addUser.do" method="post" onsubmit="return check()">
						<table class="table  table-bordered" style="width:100%;">
							<tr class="bg-primary">
								<td style="text-align: center;" colspan="2"><span style="font-size: 20px;">用户添加</span></td>
							</tr>
							<tr class="active">
								<td style="width: 120px; vertical-align: middle">用户名</td>
								<td><input type="text" style="width: 100%;" placeholder="请输入用户名" id="name" class="form-control" name="userName" id=""></td>
							</tr>
							<tr class="active">
								<td style="width: 120px; vertical-align: middle">手机号</td>
								<td><input type="text" style="width: 100%;" placeholder="请输入手机号" id="mobile" class="form-control" name="mobile" id=""></td>
							</tr>
							<tr class="active">
								<td style="width: 120px; vertical-align: middle">年龄</td>
								<td><input type="number" style="width: 100%;" placeholder="请输入年龄" id="age" class="form-control" name="age" id=""></td>
							</tr>
							<tr class="active">
								<td style="width: 120px; vertical-align: middle">邮箱</td>
								<td><input type="text" style="width: 100%;" placeholder="请输入邮箱" class="form-control" name="email" id=""></td>
							</tr>
							<tr class="active">
								<td style="width: 120px; vertical-align: middle">地址</td>
								<td><input type="text" style="width: 100%;" placeholder="请输入地址" class="form-control" name="address" id=""></td>
							</tr>
							<tr>
								<td></td>
								<td>
									<input type="button" onclick="history.back()" style="width: 200px;" class="btn btn-info" value="返回">
									<input type="submit" style="width: 200px;" class="btn btn-success" value="添加">
								</td>
							</tr>
						</table>
					</form>
